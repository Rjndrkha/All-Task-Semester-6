 ...
 * @author FAWKES
 */
public class INVENTORY extends Form implements Data{
    ...
    public INVENTORY(String nama, String jenis, String stok, String hargam, String hargaj, String income){
        initComponents();
        txnama.setText(nama);
        txjenis.setText(jenis);
        txstok.setText(stok);
        txhargamodal.setText(hargam);
        txhargajual.setText(hargaj);
    ...
    public ArrayList getData(String key){
        ...
        ArrayList data = new ArrayList();
         setKoneksi();
        String sql="Select * from inventori where idcloth like '%" + key + "%'" + "or nama like '%" + key+"%'";
       try {
        ResultSet rs=stm.executeQuery(sql);
            while (rs.next())
            {
